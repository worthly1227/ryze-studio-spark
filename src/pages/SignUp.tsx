    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary/10 via-background to-primary/5 items-center justify-center p-12 relative overflow-hidden">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="relative z-10 max-w-md">
          ...
          <h1 className="font-heading font-bold text-4xl leading-tight mb-4">
            Launch your brand's creative engine.
          </h1>
          <p className="text-muted-foreground text-lg leading-relaxed">
            Join 1,800+ product brands using Ryze to produce studio-grade content at a fraction of the cost.
          </p>
          <div className="mt-10 space-y-4">
            {[
              "AI product edits in minutes, not weeks",
              "UGC videos from vetted creators",
              "Full brand management from one dashboard",
            ].map((item) => (
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }} className="w-full max-w-sm">
          ...
          <p className="text-muted-foreground text-sm mb-8">Start producing studio-grade content today</p>

          <Button variant="outline" className="w-full mb-3 gap-2 font-medium" onClick={() => navigate("/onboarding")}>
          ...
          <form onSubmit={handleSignUp} className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="name" placeholder="Jane Doe" value={name} onChange={(e) => setName(e.target.value)} className="pl-10" required />
              </div>
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input id="password" type={showPassword ? "text" : "password"} placeholder="Min. 8 characters" value={password} onChange={(e) => setPassword(e.target.value)} className="pr-10" required minLength={8} />
          ...
          <p className="text-center text-xs text-muted-foreground mt-4">
            ...
            <Link to="/legal" className="underline">Terms</Link> and{" "}
            <Link to="/legal" className="underline">Privacy Policy</Link>.
          </p>
        </motion.div>
      </div>
    </div>
