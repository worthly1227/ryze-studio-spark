...
const FactoryProofSection: React.FC = () => {
  ...
  return (
    <section className="pt-6 sm:pt-10 pb-12 sm:pb-20 px-4 bg-muted/30 scroll-mt-20 sm:px-0 py-[20px]">
      <div className="max-w-6xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-8 sm:mb-10 my-[10px]">
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="w-full overflow-hidden py-2 sm:py-3 relative">
        ...
        <div className="flex whitespace-nowrap py-[20px]" style={{ animation: 'scroll-left 35s linear infinite', width: 'max-content' }}>
          {[...Array(8)].map((_, i) =>
